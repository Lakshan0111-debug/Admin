    ...
    <div className='adminSidebar'>
        ...
        <div className='bottom'>
            <ul>
                ...
                <Link to="/admin/manageLocations" style={{textDecoration:"none"}}>
                    <li>
                ...
                <Link to="/admin/manageGuides" style={{textDecoration:"none"}}>
                    <li>
                ...
                <Link to="/admin/manageShops" style={{textDecoration:"none"}}>
                    <li>
                ...
                <Link to="/admin/manageReviews" style={{textDecoration:"none"}}>
                    <li>
